function results = testing_ECO_HC(seq, video)
...
params.search_area_scale = 4.20;         % The scaling of the target size to get the search area
...
params.scale_learning_rate = 0.020;		% Scale filter learning rate
