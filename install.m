...
if exist('external_libs/matconvnet/matlab', 'dir') == 7
    ...
    try
        ...
        vl_compilenn('enableGpu', true,...
            'cudaRoot', 'C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v10.1', ...%你安装的cuda地址
            'cudaMethod', 'nvcc', ...
            'enableCudnn', true, ...
            'cudnnRoot', 'F:\Tracking\ECO-master\ECO-master\external_libs\matconvnet\cuda') %你安装的cudnn地址
    catch err
