function [seq, init_image_V, init_image_I] = get_sequence_info(seq)
...
if strcmpi(seq.format, 'otb')
    ...
    init_image_V = imread(seq.image_files{1});
    init_image_I = imread(seq.image_files{2});
    if ndims(init_image_I) == 2
        init_image_I = repmat(init_image_I,[1,1,3]);
    end
